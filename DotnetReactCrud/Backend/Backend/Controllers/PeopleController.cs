    ...
    public class PeopleController : ControllerBase
    {
        ...
        public async Task<IActionResult> AddPerson(Person person)
        {
            try
            {
                ...
                return CreatedAtRoute("GetPerson", new { id = person.Id }, person); // this will return 201 (Created status code) ok status code + person object in the body ** 201 created status code + location of the resource (http://localhost:3000/api/people/{id}) + person object in the response body
