...
public class DbInitializer
{
    public static async Task SeedData(AppDbContext context)
    {
        ...
        //  Right now what is happening at this stage we are just tracking inside the memory that we have updated in the memory but nothing is happening with the database at this stage.
