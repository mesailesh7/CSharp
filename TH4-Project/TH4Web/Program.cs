...
using TH4Web.Components;
using TH4Web.Components.Account;
using TH4Web.Data;
using TH4System;
...
//  :added
//  code retrieves the GroceryList connection string
var connectionStringGroceryList = builder.Configuration.GetConnectionString("GroceryList");
